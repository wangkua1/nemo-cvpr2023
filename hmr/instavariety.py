...
class Insta(Dataset):
    def __init__(self, seqlen, overlap=0., debug=False):
        ...
        self.h5_file = osp.join('/scratch/groups/syyeung/zzweng/vibe_db/insta_parts/insta_train_part_0.h5')
...
if __name__ == '__main__':
    import ipdb
    h5_file_path = osp.join('/scratch/groups/syyeung/zzweng/vibe_db/insta_parts/insta_train_part_0.h5')
